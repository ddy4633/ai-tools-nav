  ...
  return (
    <motion.div variants={variants}>
      ...
      >
        ...
        <div className="relative bg-bg-card border border-border-card rounded-xl p-5 group-hover:border-accent-cyan/40 transition-all duration-300 h-full group-hover:shadow-[0_0_30px_rgba(0,245,212,0.15)]"
        >
          {/* 头部：图标 + 名称 */}
