...
export const metadata: Metadata = {
  ...
  description: '发现最好的AI设计工具，包括AI设计助手、UI设计、平面设计、创意设计等各类人工智能设计工具。',
  keywords: ['AI设计', 'AI设计工具', 'UI设计', '平面设计', '人工智能设计'],
};
    ...
    <div className="min-h-screen bg-bg-primary">
      <div className="max-w-6xl mx-auto px-6 py-12">
        ...
        <nav className="flex items-center gap-2 text-sm text-text-muted mb-8">
          ...
          <span>/</span>
          <span className="text-text-primary">设计</span>
        </nav>
        ...
        <div className="mb-8">
          ...
          <p className="text-text-secondary max-w-2xl">
            共 {tools.length} 个AI设计工具，包括AI设计助手、UI设计、平面设计、创意设计等。
            这些工具可以帮助设计师和创意工作者提升设计效率和创意水平。
          </p>
        </div>
        ...
        {tools.length > 0 ? (
          ...
          <div className="text-center py-16 bg-white rounded-xl shadow-soft">
            ...
            <p className="text-text-primary text-lg mb-2">暂无设计工具数据</p>
