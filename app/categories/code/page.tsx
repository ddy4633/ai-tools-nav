...
export const metadata: Metadata = {
  title: '代码 AI工具 - 最好的代码人工智能工具 | AI工具导航',
  description: '发现最好的AI编程工具，包括代码助手、AI编程、代码补全、开发工具等各类人工智能编程辅助工具。',
  keywords: ['AI编程', 'AI代码', 'AI编程助手', '人工智能编程', '代码补全'],
};
...
export default async function CodeCategoryPage() {
  ...
  const tools = allTools.filter((tool: Tool) => 
    tool.category?.includes('编程') || 
    tool.category?.includes('代码') ||
    tool.category?.toLowerCase().includes('code') ||
    tool.category?.toLowerCase().includes('dev') ||
    tool.category?.includes('开发')
  );
    ...
    <div className="min-h-screen bg-bg-primary">
      <div className="max-w-6xl mx-auto px-6 py-12">
        ...
        <nav className="flex items-center gap-2 text-sm text-text-muted mb-8">
          ...
          <span>/</span>
          <span className="text-text-primary">代码</span>
        </nav>
        ...
        <div className="mb-8">
          ...
          <p className="text-text-secondary max-w-2xl">
            共 {tools.length} 个AI编程工具，包括代码助手、AI编程、代码补全、开发工具等。
            这些工具可以帮助开发者提高编码效率，自动生成和优化代码。
          </p>
        </div>
        ...
        {tools.length > 0 ? (
          ...
          <div className="text-center py-16 bg-white rounded-xl shadow-soft">
            ...
            <p className="text-text-primary text-lg mb-2">暂无编程工具数据</p>
