...
export const metadata: Metadata = {
  ...
  description: '发现最好的AI视频工具，包括视频生成、视频编辑、AI剪辑、视频特效等各类人工智能视频处理工具。',
  keywords: ['AI视频', 'AI视频生成', '视频编辑', 'AI剪辑', '人工智能视频'],
};
...
export default async function VideoCategoryPage() {
  ...
  const tools = allTools.filter((tool: any) => 
    tool.category?.includes('视频') || 
    tool.category?.toLowerCase().includes('video') ||
    tool.category?.includes('剪辑') ||
    tool.category?.includes('影视')
  );
      ...
      <div className="max-w-6xl mx-auto px-6 py-12">
        ...
        <div className="mb-8">
          ...
          <p className="text-text-secondary max-w-2xl">
            共 {tools.length} 个AI视频工具，包括视频生成、视频编辑、AI剪辑、视频特效等。
            这些工具可以帮助你创建和编辑专业级视频内容，提升视频制作效率。
          </p>
        </div>
        ...
        {tools.length > 0 ? (
          ...
          <div className="text-center py-16 bg-white rounded-xl shadow-soft">
            ...
            <p className="text-text-primary text-lg mb-2">暂无视频工具数据</p>
